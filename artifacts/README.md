...
Spice Route 1.6.0 combines the Side by side Overview and Workbench project selector. Windows uses WinUI 3; macOS uses the shared React interface in Tauri.

- [Windows x64](Spice-Route-1.6.0-windows-x64-setup.exe), for Intel and AMD computers
- [Windows ARM64](Spice-Route-1.6.0-windows-arm64-setup.exe), for Windows on Arm computers
- [macOS Apple Silicon](macos-apple-silicon/Spice-Route-1.6.0-macos-apple-silicon.dmg), for M-series Macs
...
See the [main README](../README.md) for setup and the [1.6.0 verification guide](../docs/testing-1.6.0.md) for checks and remaining acceptance work.
