...
const ocean: BrandVariants = {
  ...
  130: "#BED9E3", 140: "#D8E7E9", 150: "#EAEFEA", 160: "#B5D4E5",
};
...
const light = { ...createLightTheme(ocean), ...common, colorBrandBackground: ocean[30], colorBrandBackgroundHover: ocean[40], colorBrandBackgroundPressed: ocean[20], colorBrandForeground1: ocean[30], colorCompoundBrandBackground: ocean[30], colorNeutralBackground1: "#FFFFFF", colorNeutralForeground1: "#29333A" };
const dark = { ...createDarkTheme(ocean), ...common, colorBrandBackground: "#B5D4E5", colorBrandBackgroundHover: "#C5E1EF", colorBrandBackgroundPressed: "#99BDCF", colorNeutralForegroundOnBrand: ocean[20], colorBrandForeground1: "#B5D4E5", colorCompoundBrandBackground: "#B5D4E5", colorNeutralBackground1: "#29333A", colorNeutralForeground1: "#EDF0ED" };
